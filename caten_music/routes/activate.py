...
activate_account_bp = Blueprint('activate_account_bp', __name__, template_folder='templates')

resend_activate_mail_bp = Blueprint('resend_activate_mail_bp', __name__, template_folder='templates')

reset_password_bp = Blueprint('reset_password_bp', __name__, template_folder='templates')

ajax_validate_email_bp = Blueprint('ajax_validate_email_bp', __name__, template_folder='templates')
    ...
    if step == 'setting':
        if request.method == 'POST':
            ...
            try:
                ...
                check_result = helper.checkFormat('checkusername', 'check@email.com', 'checkdisplayname', password)
