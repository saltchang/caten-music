...
ajax_validate_login_bp = Blueprint('ajax_validate_login_bp', __name__, template_folder='templates')
...
def login():
    ...
    if request.method == 'POST':
        ...
        # 如果有欄位的資料錯誤，則回傳之前端
        if check_result['primary_check'] == 'failed' or not check_result['password_check']:
